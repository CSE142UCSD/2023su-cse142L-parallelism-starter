...
//	theDataCollector->disable_prefetcher();
	...
	sprintf(header,"reps,size,size2,threads,arg1,arg2,arg3,function,IC,Cycles,CPI,CT,ET,L1_dcache_miss_rate,L1_dcache_misses,L1_dcache_accesses,branches,branch_misses");
...
//									    env->sort_data(params);
									...
									{
										sprintf(preamble, "%d,%lu,%lu,%lu,%lu,%lu,%lu,%s,",reps,size,size2,thread,arg1,arg2,arg3,function.c_str());
										perfstats_init();
